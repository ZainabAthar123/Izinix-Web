  ...
  return (
    ...
    >
      ...
      <FadeIn
        ...
        style={{ position: 'absolute', top: '4%', left: '1%' }}
        className="sm:!left-[2%] md:!left-[4%]"
      >
        <img
      ...
      <FadeIn
        ...
        className="sm:!left-[6%] md:!left-[10%]"
      >
        <img
      ...
      <FadeIn
        ...
        className="sm:!right-[2%] md:!right-[4%]"
      >
        <img
      ...
      <FadeIn
        ...
        className="sm:!right-[6%] md:!right-[10%]"
      >
        <img
      ...
      >
        ...
        <div
          className="gap-16 sm:gap-20 md:gap-24"
